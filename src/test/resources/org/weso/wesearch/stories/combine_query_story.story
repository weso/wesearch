...
Then I get combined query SELECT ?res WHERE { ?res <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?a . ?res <http://datos.bcn.cl/ontologies/bcn-biographies#bornPlace> ?b . ?b <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?c . ?b <http://datos.bcn.cl/ontologies/bcn-biographies#countryName> ?d . FILTER( regex(?d, "Chile", "i") ) .FILTER( ?c = <http://datos.bcn.cl/ontologies/bcn-biographies#Place>  ) .FILTER( ?a = <http://datos.bcn.cl/ontologies/bcn-biographies#Ministro> || ?a = <http://www.w3.org/2002/07/owl#Nothing>  ) .}
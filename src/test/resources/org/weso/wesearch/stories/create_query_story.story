...
Then I get query SELECT ?res WHERE { ?res <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?a . ?res <http://datos.bcn.cl/ontologies/bcn-biographies#nacido_en> ?b . FILTER( regex(?b, "Chile", "i") ) .FILTER( ?a = <http://datos.bcn.cl/ontologies/bcn-biographies#Ministro> OR ?a = <http://www.w3.org/2002/07/owl#Nothing>  ) .}
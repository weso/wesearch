...
Then I get query SELECT ?res WHERE { ?res <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://datos.bcn.cl/ontologies/bcn-biographies#Ministro> . ?res <http://datos.bcn.cl/ontologies/bcn-biographies#nacido_en> ?a . FILTER(regex(?a, "Chile", "i")) . }
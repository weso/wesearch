...
import org.weso.wesearch.steps.FindLocation;

public class FindLocationStory extends JUnitStory {
	...
	public List<CandidateSteps> candidateSteps() {
		return new InstanceStepsFactory(configuration(), new FindLocation())

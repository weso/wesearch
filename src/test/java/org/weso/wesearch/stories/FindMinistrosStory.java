...
import org.weso.wesearch.steps.FindMinistros;

public class FindMinistrosStory extends JUnitStory {
	...
	public List<CandidateSteps> candidateSteps() {
		return new InstanceStepsFactory(configuration(), new FindMinistros())

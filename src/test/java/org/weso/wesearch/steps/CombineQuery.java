...
public class CombineQuery extends Steps {
	...
	@Given("a matter ?m, property ?p, value selector ?selector, value ?value and clauses query ?clause1 and ?cluase 2")
	public void loadQueryAndParameters(String clause1, String clause2, String m, String p, 
			String selector, String value) throws 
		...
		property = new JenaPropertyImpl("", "Nombre", 
